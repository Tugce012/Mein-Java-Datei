...
//getMonth(): Bu metod ayı döndürür. (Month enum türünde)
...
//ornek 3: getYear(): Tarihin yılını alır.
        ...
        System.out.println(myDate.getDayOfYear()); //276, yilin 276.günü

//------------
// ornek 4:getDayOfMonth(): Ayin gününü alır.
        int day1 = myDate.getDayOfMonth();
        System.out.println(day1); //2, ayin 2. günü
...
Sonuç olarak, çıkarma işleminden sonra elde edilen tarihi döndürürler.*/
        ...
        System.out.println(myDate.minusYears(2).minusMonths(3).minusDays(1)); //2022-07-01
