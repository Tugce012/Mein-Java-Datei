...
public class WrapperClass {
    public static void main(String[] args) {
        ...
        int i = 12;
       // i. yaptiginizda method acilmaz. cunku bu primitive

        Integer k = 12;
        //k yaptigimizda methodlar acilir, cunku bu bir class.
        ...
        //Ornek2: Wrapper Byte'i prmitive byte'a ceviriniz.(unboxing)
        Byte s = 19;
        byte primitiveS = s;
