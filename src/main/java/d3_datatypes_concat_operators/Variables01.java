...
public class Variables01 {
    public static void main(String[] args) {
        ...
        System.out.println("TotalPrice2: " + (sockPrice2 + shirtPrice2)); //TotalPrice2: 38.98
        ...
        double cellWeight = 0.00000000000000028;
        System.out.println(cellWeight); //2.8E-16 ==> 2.8 carpi 10 uzeri -16 demektir
        ...
        System.out.println(firstLetterOfTheName); //T
