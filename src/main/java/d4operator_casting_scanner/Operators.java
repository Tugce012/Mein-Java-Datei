...
public class Operators {
    public static void main(String[] args) {
        ...
        System.out.println(amountOfMoney1 / numberOfPeople1); //Sonuc 2 cikti. 2.5 cikmaliydi. java .5'i sildi.

        double amountOfMoney2 = 25; //8 byte ondalikli sayi
        int numberOfPeople2 =10; // 4 byte tamsayi
        //büyüklükten kasit daha fazla bilgi depolayabilmesidir.
        ...
        boolean c = 2 + 3 * 5 >= 19; //false, önce carpma yapilmali
