...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        //Ornek 1: byte data type’ ini int data type’ina ceviriniz. //bu islem AutoWidening'dir.
        //Example 1: Convert byte data type to int data type.

        byte age = 13;
        int ageInt = age;

        //Ornek 2: int data type’ ini short data type’ ina ceviriniz. //bu islem Explicit Narrowing"(Aciktan Daraltma)'dir.
