...
public class Arrays04 {
    public static void main(String[] args) {
        ...
        for (int w : arr) {
            if (w != 0) {
                newArr[firstIndex] = w; //bos array'in ilk index'ine 0 olmayan sayiyi yükledik
                firstIndex++; //ilk index'e yükleme yapildigi icin bir sonraki sifir harici sayi ilk index'e yüklenmesin diye 1 artirdik.
            }
        }
