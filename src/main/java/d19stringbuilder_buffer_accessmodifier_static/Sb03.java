...
public class Sb03 {
    public static void main(String[] args) {
        ...
        System.out.println(result); //15 //ascii tablosundan K ve Z arasindaki farki verdi.
       ...
       String str = sb1.toString().toUpperCase();
        System.out.println(str); //HA34SANSI AVAJ //StringBuilder'i String'e cevirdik
        ...
        System.out.println(newSb1); //HA34SANSI AVAJ //Data type tekrar strinBuilder oldu
        ...
        */
        ...
        /*Tek iş parçacığı (Single-Threaded), aynı anda sadece bir görevi işleyebilirken, birden fazla iş parçacığı (Multi-Threaded) aynı anda
