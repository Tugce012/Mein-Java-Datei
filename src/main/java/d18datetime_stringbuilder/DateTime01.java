...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println(formattedDate); //04-Oktober-2024
        ...
        System.out.println(dateInTokyo); //2024-10-04  //Arastirma Ödevi:Java bu bilgiyi Internetten mi cekiyor?
        ...
        System.out.println(timeInTokyo); //17:34:44.511356
